    ...
    <footer className="bg-slate-950 border-t border-slate-800 text-slate-400 text-xs py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-12 border-b border-slate-800/80">
          ...
          <div className="md:col-span-1 space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="font-extrabold text-lg text-white font-outfit">seosorted.ai</span>
            </div>
          ...
          {/* Col 2 Product */}
          <div>
            <h4 className="font-semibold text-white uppercase tracking-wider mb-3 text-[11px]">Product</h4>
          ...
          {/* Col 3 Resources */}
          <div>
            <h4 className="font-semibold text-white uppercase tracking-wider mb-3 text-[11px]">Free Micro-Tools</h4>
            <ul className="space-y-2">
          ...
          {/* Col 4 Integrations */}
          <div>
            <h4 className="font-semibold text-white uppercase tracking-wider mb-3 text-[11px]">CMS Connections</h4>
            <ul className="space-y-2">
              <li><span className="text-slate-300">WordPress REST API</span></li>
              <li><span className="text-slate-300">Webflow CMS Webhook</span></li>
              <li><span className="text-slate-300">Shopify Blog API</span></li>
              <li><span className="text-slate-300">Ghost Admin API</span></li>
            </ul>
          </div>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p>© 2026 SEOSorted AI Inc. All rights reserved.</p>
          <div className="flex items-center gap-4 text-slate-400">
            <a href="#" className="hover:text-white"><Globe className="w-4 h-4" /></a>
            <a href="#" className="hover:text-white"><Share2 className="w-4 h-4" /></a>
            <a href="#" className="hover:text-white"><Code className="w-4 h-4" /></a>
            <a href="#" className="hover:text-white"><Mail className="w-4 h-4" /></a>
          </div>
        </div>
