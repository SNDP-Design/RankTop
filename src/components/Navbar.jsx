          ...
          <div className="flex items-center gap-3">
            <div className="hidden sm:flex items-center gap-2 bg-[#171717] border border-[#262626] rounded-full px-3.5 py-1 text-sm">
              ...
              <span className="text-white font-semibold flex items-center gap-1.5">
                <Globe className="w-4 h-4 text-[#3ECF8E]" aria-hidden="true" /> mywebsite.com
              </span>
            ...
            <button
              ...
              className="px-4 py-2 bg-[#3ECF8E] hover:bg-[#34D399] text-black font-bold text-sm rounded-lg shadow-md shadow-[#3ECF8E]/20 flex items-center gap-2 transition-all focus-visible:ring-2 focus-visible:ring-[#3ECF8E] focus-visible:outline-none"
            >
