    ...
    <aside className="w-64 bg-slate-900 border-r border-slate-800 flex flex-col justify-between shrink-0 min-h-[calc(100vh-64px)]">
      ...
      <div className="p-4 space-y-6">
          ...
          <div className="flex items-center gap-2.5 overflow-hidden">
            ...
            <div className="truncate">
              ...
              <span className="text-sm text-emerald-400 flex items-center gap-1.5 font-mono">
                <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" /> RankTop Active
              </span>
            </div>
          </div>
        ...
        <nav className="space-y-1">
          <span className="px-3 text-sm font-mono uppercase tracking-wider text-slate-500 font-bold block mb-2">
      ...
      <div className="p-4 border-t border-slate-800">
        <div className="p-3 bg-gradient-to-b from-brand-950/60 to-slate-950 rounded-xl border border-brand-500/20 text-sm">
          <div className="flex items-center justify-between mb-2">
            <span className="font-bold text-white flex items-center gap-1.5">
              <Sparkles className="w-4 h-4 text-brand-400" /> RankTop Swarm
            </span>
            <span className="text-sm font-mono text-emerald-400 bg-emerald-500/10 px-2 py-0.5 rounded">6 Agents</span>
          </div>
