...
export default function DashboardOverview({ activeWebsiteUrl = 'mywebsite.com', setActiveTab }) {
  ...
  return (
    <div className="w-full space-y-4 font-sans">
      ...
      {/* Top Header Banner */}
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 bg-[#171717] p-5 rounded-2xl border border-[#262626]">
        <div>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#3ECF8E]/10 text-[#3ECF8E] text-xs font-semibold mb-1.5 border border-[#3ECF8E]/20">
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          <button 
            ...
            disabled={isScanning}
            className="px-3.5 py-2 bg-[#1F1F1F] hover:bg-[#262626] text-zinc-200 rounded-xl text-xs font-semibold flex items-center gap-2 border border-[#333] transition-all"
          >
          ...
          <button 
            ...
            className="px-3.5 py-2 bg-[#3ECF8E] hover:bg-[#34D399] text-black font-bold text-xs rounded-xl shadow flex items-center gap-1.5 transition-all"
          >
      ...
      {/* 3 Core Trifecta Scorecards with gap-4 */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        
        {/* 1. SEO Scorecard */}
        <div className="bg-[#171717] p-4 rounded-2xl border border-[#262626] space-y-3 relative overflow-hidden">
          ...
          <div className="grid grid-cols-2 gap-2.5 pt-0.5">
            <div className="p-2.5 bg-[#121212] rounded-xl border border-[#262626]">
              ...
              <span className="text-xl font-extrabold text-white">{metrics.clicks}</span>
            ...
            <div className="p-2.5 bg-[#121212] rounded-xl border border-[#262626]">
              ...
              <span className="text-xl font-extrabold text-white">{metrics.impressions}</span>
        ...
        <div className="bg-[#171717] p-4 rounded-2xl border border-[#262626] space-y-3 relative overflow-hidden">
          ...
          <div className="grid grid-cols-2 gap-2.5 pt-0.5">
            <div className="p-2.5 bg-[#121212] rounded-xl border border-[#262626]">
              ...
              <span className="text-xl font-extrabold text-white">{metrics.aeoCitationScore}</span>
            ...
            <div className="p-2.5 bg-[#121212] rounded-xl border border-[#262626]">
              ...
              <span className="text-xl font-extrabold text-white">{metrics.voiceExtractionScore}</span>
        ...
        <div className="bg-[#171717] p-4 rounded-2xl border border-[#262626] space-y-3 relative overflow-hidden">
          ...
          <div className="grid grid-cols-2 gap-2.5 pt-0.5">
            <div className="p-2.5 bg-[#121212] rounded-xl border border-[#262626]">
              ...
              <span className="text-xl font-extrabold text-white">{metrics.chatGptScore}</span>
            ...
            <div className="p-2.5 bg-[#121212] rounded-xl border border-[#262626]">
              ...
              <span className="text-xl font-extrabold text-white">{metrics.claudeScore}</span>
      ...
      {/* Visual Charts Section with gap-4 & space-y-4 */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        
        {/* Graph 1: SEO Traffic Growth Curve */}
        <div className="lg:col-span-8 bg-[#171717] p-5 rounded-2xl border border-[#262626] space-y-3">
          <div className="flex items-center justify-between border-b border-[#262626] pb-2.5">
            <div>
              <h3 className="text-sm font-bold text-white font-sans">Google Search Organic Clicks Curve</h3>
              <p className="text-xs text-zinc-400">Monthly organic traffic telemetry for {domain}</p>
            </div>
            <span className="text-xs font-bold text-[#3ECF8E] bg-[#3ECF8E]/10 px-2 py-0.5 rounded border border-[#3ECF8E]/20">
              +142% Traffic Growth
            </span>
          </div>

          <div className="h-48 w-full bg-[#121212] rounded-xl p-3.5 border border-[#262626] flex items-end justify-between gap-2">
        ...
        <div className="lg:col-span-4 bg-[#171717] p-5 rounded-2xl border border-[#262626] space-y-3">
          <div className="flex items-center justify-between border-b border-[#262626] pb-2.5">
            <h3 className="text-sm font-bold text-white font-sans">Keyword Ranking Breakdown</h3>
      ...
      {/* Bar Chart: LLM Chatbot Citation Scores with gap-4 & space-y-4 */}
      <div className="bg-[#171717] p-5 rounded-2xl border border-[#262626] space-y-3">
        <div className="flex items-center justify-between border-b border-[#262626] pb-2.5">
          <div>
            <h3 className="text-sm font-bold text-white font-sans">GEO LLM Answer Engine Citation Rates</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="p-3.5 bg-[#121212] rounded-xl border border-[#262626] space-y-2">
      ...
      {/* Recommendations & Top Articles Table with gap-4 */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start">
        
        {/* Simple Actionable Checklist */}
        <div className="lg:col-span-6 bg-[#171717] p-5 rounded-2xl border border-[#262626] space-y-3">
          <div className="flex items-center justify-between border-b border-[#262626] pb-2.5">
            <h3 className="text-sm font-bold text-white font-sans">Suggested Actions to Rank Higher</h3>
          ...
          <div className="space-y-2.5">
            {actionItems.map((item) => (
              ...
              >
                <div>
                  <div className="flex items-center gap-2">
                    <span className="bg-[#3ECF8E]/10 text-[#3ECF8E] text-[10px] px-2 py-0.5 rounded font-bold">{item.tag}</span>
        ...
        <div className="lg:col-span-6 bg-[#171717] p-5 rounded-2xl border border-[#262626] space-y-3">
          <div className="flex items-center justify-between border-b border-[#262626] pb-2.5">
            <h3 className="text-sm font-bold text-white font-sans">Top Ranking Articles</h3>
          ...
          <div className="space-y-2">
            {articles.map((art, idx) => (
              <div key={idx} className="p-3 bg-[#121212] rounded-xl border border-[#262626] flex items-center justify-between gap-3">
                <div>
