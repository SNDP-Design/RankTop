        ...
        <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '16px' }}>
            ...
            <div style={{ background: '#171717', border: '1px solid #262626', borderRadius: '14px', padding: '18px 20px' }}>
              ...
              <div style={{ fontSize: '14px', color: '#f59e0b', marginTop: '4px', fontWeight: 600 }}>Ready for 1-click pitch</div>
            </div>
            ...
            <div style={{ background: '#171717', border: '1px solid #262626', borderRadius: '14px', padding: '18px 20px' }}>
              ...
              <div style={{ fontSize: '14px', color: '#06b6d4', marginTop: '4px', fontWeight: 600 }}>Active Search Target</div>
            </div>
          </div>
        </>
      )}
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1fr_420px] gap-5">
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '6px' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                        ...
                        <span style={{
                          fontSize: '14px', fontWeight: 600, background: '#222', color: '#a78bfa',
                      ...
                      <span style={{ fontSize: '14px', fontWeight: 600, color: isSent ? '#3ECF8E' : '#a1a1aa' }}>
                        {isSent ? 'Sent ✓' : p.status}
                      </span>
                    </div>

                    <p style={{ fontSize: '14px', color: '#71717a', margin: '4px 0 8px', lineHeight: '1.4' }}>
                      "{p.snippet}"
                    </p>

                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', fontSize: '14px', color: '#52525b' }}>
        ...
        <div style={{ background: '#171717', border: '1px solid #262626', borderRadius: '16px', padding: '20px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '1px solid #262626', pb: '12px' }}>
            ...
            <span style={{ fontSize: '14px', fontWeight: 600, color: '#3ECF8E' }}>
              Gemini 3.6 Flash
            </span>
          </div>
          ...
          {selectedProspect ? (
            <>
              ...
              <div style={{ background: '#121212', border: '1px solid #262626', borderRadius: '10px', padding: '12px 14px' }}>
                <div style={{ fontSize: '14px', color: '#71717a', textTransform: 'uppercase', fontWeight: 700, letterSpacing: '0.05em' }}>
              ...
              {/* Email Subject Line */}
              <div>
                <label style={{ fontSize: '14px', fontWeight: 600, color: '#a1a1aa', display: 'block', marginBottom: '6px' }}>
                  Email Subject Line
                </label>
                <input
                  type="text"
              ...
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                ...
                <textarea
                  ...
                  style={{
                    width: '100%', background: '#121212', border: '1px solid #2d2d2d',
                    borderRadius: '8px', padding: '12px', color: '#d4d4d8', fontSize: '14px',
              ...
              <div style={{ display: 'flex', gap: '10px' }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    padding: '10px', borderRadius: '8px', fontWeight: 700, fontSize: '14px', cursor: 'pointer'
                  }}
                >
            ...
            <div style={{ textAlign: 'center', padding: '32px 16px', color: '#71717a', fontSize: '14px' }}>
